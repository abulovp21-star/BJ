...
DEALER_DELAY     = 3.0    # pause between dealer actions
N_DECKS          = 6
MIN_BET          = 100
MAX_BET          = 1_000_000
...
CARD_SKINS = {
    ...
    "referral3":   {"name": "🎁 Referral Gold",   "price": None, "referral_only": True},
}
PROFILE_FRAMES = {
    ...
    "referral5":{"name": "🎗️ Referral Circle","price": None, "referral_only": True},
}
...
async def game_end(room):
    ...
    for p in room["players"]:
        ...
        bust = pt > 21
        if bust and dl_bust:
            p["result"] = "push";      p["win"] = p["bet"]   # both busted — bet returned
        elif bust:
