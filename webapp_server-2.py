...
CARD_SKINS = {
    ...
    "neonblue":    {"name": "⚡ Neon Blue",     "price": 15},
    "neonpurple":  {"name": "🟣 Neon Purple",   "price": 19},
    "casinored":   {"name": "🔴 Casino Red",    "price": 25},
    "tablegreen":  {"name": "🟢 Table Green",   "price": 29},
    "metalsteel":  {"name": "🪙 Metal Steel",   "price": 39},
    "royalpattern":{"name": "🧿 Royal Pattern", "price": 59},
    "obsidian":    {"name": "⬛ Obsidian",      "price": 45},
    "aurora":      {"name": "🌈 Aurora",        "price": 69},
}
PROFILE_FRAMES = {
    "none":     {"name": "None",             "price": 0},
    "electric": {"name": "⚡ Электрическая",  "price": 19},
    "fire":     {"name": "🔥 Огненная",       "price": 39},
    "space":    {"name": "🌌 Космос",         "price": 59},
    "diamond":  {"name": "💎 Алмазная",       "price": 89},
    "casino":   {"name": "💰 Казино",         "price": 129},
    "royal":    {"name": "👑 Королевская",    "price": 179},
    "ocean":    {"name": "🌊 Океан",          "price": 49},
    "blossom":  {"name": "🌸 Сакура",         "price": 69},
}
...
async def game_end(room):
    ...
    for p in room["players"]:
        ...
        await db_add_history(p["uid"], p["bet"], p["result"], p["win"] - p["bet"])
        results.append({
            "uid":     p["uid"],
            "result":  p["result"],
            "win":     p["win"],
