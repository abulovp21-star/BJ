...
TX['en'] = {
    ...
    'addfriend_notfound': '❌ User not found. Use /addfriend <id or @username>.',
    'addfriend_already': '✅ You\'re already friends.',
    'addfriend_pending': '⏳ Request already pending.',
    'addfriend_sent': '✅ Friend request sent to <b>{name}</b>.',
    'addfriend_gone': 'This request is no longer valid.',
    'now_friends_bot': '🤝 You are now friends!',
    'request_declined': 'Request declined.',
    'friend_request_in': '👥 <b>{name}</b> wants to add you as a friend!',
    'invite_muted_ok': '🔇 Invites from this player muted for 24h.',
    ...
    'btn_shop_gift': '🎁 Gift diamonds to a friend',
    'gift_no_friends': "You don't have any friends yet — add one first (/friends), then come back to gift them diamonds.",
    'gift_pick_friend': '🎁 Choose a friend to gift diamonds to:',
    'gift_pick_amount': '🎁 Choose an amount:',
    'gift_invoice_title': '🎁 {amt}💎 gift',
    'gift_invoice_desc': 'Gift diamonds to a friend in Blackjack',
    'duel_usage_title': '🃏 BlackJack Duel',
    'duel_usage_desc': 'Type: @username 1000 — challenge a specific player to a 1-on-1 duel for that bet.',
    'duel_bad_bet_title': '❌ Invalid bet',
    'duel_bad_bet_desc': 'Bet must be between {mn:,} and {mx:,}¢.',
    'duel_user_notfound_title': '❌ Player not found',
    'duel_user_notfound_desc': "That user hasn't started the bot yet, or the username is wrong.",
    'duel_no_balance_title': '❌ Not enough balance',
    'duel_no_balance_desc': "You don't have enough chips for that bet.",
    'duel_card': '🃏 <b>BlackJack Duel</b>\n\n👤 {a} VS 👤 {b}\n💰 Bet: {bet}¢\n\n⏳ Waiting for opponent...',
    'duel_accept_btn': '✅ Accept duel',
    'duel_result_title': '🃏 Challenge {name} to a duel',
    'duel_result_desc': 'Bet: {bet}¢ — tap to send the challenge',
    'duel_gone': 'This duel is no longer available.',
    'duel_cant_accept_own': "You can't accept your own duel.",
    'duel_wrong_player': '❌ This duel is meant for another player.',
    'duel_accepted_card': '🃏 <b>BlackJack Duel</b>\n\n👤 {a} VS 👤 {b}\n💰 Bet: {bet}¢\n\n✅ Opponent accepted the challenge!\nGame starting...',
    'duel_open_btn': '🎮 Open game',
    'duel_accepted_ok': '✅ Accepted! Opening the game...',
    'btn_top': '🏆 Top',
    'btn_ref': '🔗 Referral',
...
TX['ru'] = {
    ...
    'addfriend_notfound': '❌ Пользователь не найден. Используй /addfriend <id или @юзернейм>.',
    'addfriend_already': '✅ Вы уже друзья.',
    'addfriend_pending': '⏳ Заявка уже отправлена ранее.',
    'addfriend_sent': '✅ Заявка в друзья отправлена <b>{name}</b>.',
    'addfriend_gone': 'Эта заявка больше не действительна.',
    'now_friends_bot': '🤝 Теперь вы друзья!',
    'request_declined': 'Заявка отклонена.',
    'friend_request_in': '👥 <b>{name}</b> хочет добавить тебя в друзья!',
    'invite_muted_ok': '🔇 Приглашения от этого игрока отключены на 24 часа.',
    ...
    'btn_shop_gift': '🎁 Подарить алмазы другу',
    'gift_no_friends': 'У тебя пока нет друзей — сначала добавь через /friends, потом возвращайся дарить алмазы.',
    'gift_pick_friend': '🎁 Выбери друга, которому подарить алмазы:',
    'gift_pick_amount': '🎁 Выбери сумму:',
    'gift_invoice_title': '🎁 Подарок {amt}💎',
    'gift_invoice_desc': 'Подарок алмазов другу в Blackjack',
    'duel_usage_title': '🃏 BlackJack Дуэль',
    'duel_usage_desc': 'Напиши: @username 1000 — вызвать конкретного игрока на дуэль 1 на 1 с такой ставкой.',
    'duel_bad_bet_title': '❌ Некорректная ставка',
    'duel_bad_bet_desc': 'Ставка должна быть от {mn:,} до {mx:,}¢.',
    'duel_user_notfound_title': '❌ Игрок не найден',
    'duel_user_notfound_desc': 'Этот пользователь ещё не запускал бота, либо юзернейм неверный.',
    'duel_no_balance_title': '❌ Недостаточно баланса',
    'duel_no_balance_desc': 'У тебя не хватает фишек для такой ставки.',
    'duel_card': '🃏 <b>BlackJack Дуэль</b>\n\n👤 {a} VS 👤 {b}\n💰 Ставка: {bet}¢\n\n⏳ Ожидание соперника...',
    'duel_accept_btn': '✅ Принять дуэль',
    'duel_result_title': '🃏 Вызвать {name} на дуэль',
    'duel_result_desc': 'Ставка: {bet}¢ — нажми, чтобы отправить вызов',
    'duel_gone': 'Эта дуэль больше не доступна.',
    'duel_cant_accept_own': 'Нельзя принять собственную дуэль.',
    'duel_wrong_player': '❌ Эта дуэль предназначена для другого игрока.',
    'duel_accepted_card': '🃏 <b>BlackJack Дуэль</b>\n\n👤 {a} VS 👤 {b}\n💰 Ставка: {bet}¢\n\n✅ Соперник принял вызов!\nИгра начинается...',
    'duel_open_btn': '🎮 Открыть игру',
    'duel_accepted_ok': '✅ Принято! Открываю игру...',
    'btn_top': '🏆 Топ',
    'btn_ref': '🔗 Реферал',
...
CREATE TABLE IF NOT EXISTS invite_mutes(
    muter_uid BIGINT,
    inviter_uid BIGINT,
    until_ts BIGINT,
    PRIMARY KEY(muter_uid, inviter_uid)
);
...
async def is_subscribed(uid: int) -> bool:
    ...
    try:
        ...
        log.warning(f"is_subscribed uid={uid} could not verify ({e}) — denying by default. "
                    f"If this fires for every user, check that the bot is an ADMIN of {CHANNEL_USERNAME} "
                    f"and that CHANNEL_USERNAME is set correctly.")
        return False   # fail-closed: if we can't verify, don't grant the reward

def win_pct(u): return round(u["w_bj"] / (u["w_bj"]+u["l_bj"]) * 100, 1) if u and (u["w_bj"]+u["l_bj"]) else 0.0
...
def shop_main_kb(lang):
    return IKM(inline_keyboard=[
        ...
        [IKB(text=t(lang,"btn_shop_gift"), callback_data="shopm|gift")],
    ])

GIFT_DIAMOND_PACKS = {
    "gift1": (10, 12), "gift2": (25, 28), "gift3": (50, 52), "gift4": (100, 100), "gift5": (250, 235),
}  # code: (diamonds, ⭐ cost) — mirrors webapp_server.py's packs
...
async def do_ref(uid, cid):
    ...
    ref_count = (await dbq("SELECT COUNT(*) AS n FROM users WHERE ref_by=$1", uid))["n"]
    await send(cid, t(lang,"ref_msg", n=ref_count), kb=share_kb(lang, link))

async def do_friends(uid, cid):
    lang = await eff_lang(cid, uid)
    friends = await dba(
        "SELECT u.uid, u.name, u.last_seen FROM friendships f "
        "JOIN users u ON u.uid = (CASE WHEN f.uid_a=$1 THEN f.uid_b ELSE f.uid_a END) "
        "WHERE (f.uid_a=$1 OR f.uid_b=$1) AND f.status='accepted' ORDER BY u.last_seen DESC", uid)
    incoming = await dba(
        "SELECT u.uid, u.name FROM friendships f "
        "JOIN users u ON u.uid = (CASE WHEN f.uid_a=$1 THEN f.uid_b ELSE f.uid_a END) "
        "WHERE (f.uid_a=$1 OR f.uid_b=$1) AND f.status='pending' AND f.requested_by != $1", uid)
    text = t(lang, "friends_msg", n=len(friends), req=len(incoming))
    if friends:
        text += "\n\n" + t(lang,"friends_list_title") + "\n" + "\n".join(
            f"• {await mention(f['uid'], f['name'])}" for f in friends[:20])
    kb_rows = []
    for r in incoming[:10]:
        kb_rows.append([
            IKB(text=f"✅ {r['name']}", callback_data=f"freq|acc|{r['uid']}"),
            IKB(text="❌", callback_data=f"freq|dec|{r['uid']}"),
        ])
    if WEBAPP_URL:
        kb_rows.append([IKB(text=t(lang,"btn_open_friends"), web_app=WebAppInfo(url=WEBAPP_URL))])
    await send(cid, text, kb=IKM(inline_keyboard=kb_rows) if kb_rows else None)

async def do_addfriend(uid, cid, arg):
    lang = await eff_lang(cid, uid)
    tu = await _resolve_uid(arg)
    if not tu or tu["uid"] == uid:
        await send(cid, t(lang,"addfriend_notfound")); return
    a, b = (uid, tu["uid"]) if uid < tu["uid"] else (tu["uid"], uid)
    existing = await dbq("SELECT status, requested_by FROM friendships WHERE uid_a=$1 AND uid_b=$2", a, b)
    if existing and existing["status"] == "accepted":
        await send(cid, t(lang,"addfriend_already")); return
    if existing and existing["requested_by"] != uid:
        await dbx("UPDATE friendships SET status='accepted' WHERE uid_a=$1 AND uid_b=$2", a, b)
        await send(cid, t(lang,"now_friends_bot"))
        tlang = await get_lang(tu["uid"])
        await send(tu["uid"], t(tlang,"now_friends_bot"))
        return
    if existing:
        await send(cid, t(lang,"addfriend_pending")); return
    await dbx("INSERT INTO friendships(uid_a,uid_b,status,requested_by,created_at) VALUES($1,$2,'pending',$3,$4)",
              a, b, uid, int(time.time()))
    me = await gu(uid)
    await send(cid, t(lang,"addfriend_sent", name=tu["name"]))
    tlang = await get_lang(tu["uid"])
    await send(tu["uid"], t(tlang,"friend_request_in", name=(me or {}).get("name","Игрок")),
               kb=IKM(inline_keyboard=[[
                   IKB(text="✅", callback_data=f"freq|acc|{uid}"),
                   IKB(text="❌", callback_data=f"freq|dec|{uid}"),
               ]]))

@dp.callback_query(F.data.startswith("freq|"))
async def cb_friend_request(c: CallbackQuery):
    _, action, other_s = c.data.split("|")
    other = int(other_s); uid = c.from_user.id
    lang = await get_lang(uid)
    a, b = (uid, other) if uid < other else (other, uid)
    row = await dbq("SELECT status, requested_by FROM friendships WHERE uid_a=$1 AND uid_b=$2", a, b)
    if not row or row["status"] != "pending" or row["requested_by"] == uid:
        await c.answer(t(lang,"addfriend_gone"), show_alert=True); return
    if action == "acc":
        await dbx("UPDATE friendships SET status='accepted' WHERE uid_a=$1 AND uid_b=$2", a, b)
        await c.answer(t(lang,"now_friends_bot"))
        ou = await gu(other); olang = await get_lang(other)
        if ou: await send(other, t(olang,"now_friends_bot"))
    else:
        await dbx("DELETE FROM friendships WHERE uid_a=$1 AND uid_b=$2", a, b)
        await c.answer(t(lang,"request_declined"))
    try: await c.message.edit_reply_markup(reply_markup=None)
    except Exception: pass

@dp.callback_query(F.data.startswith("mute_invite|"))
async def cb_mute_invite(c: CallbackQuery):
    inviter_uid = int(c.data.split("|")[1])
    uid = c.from_user.id
    lang = await get_lang(uid)
    until = int(time.time()) + 86400
    await dbx(
        "INSERT INTO invite_mutes(muter_uid,inviter_uid,until_ts) VALUES($1,$2,$3) "
        "ON CONFLICT (muter_uid,inviter_uid) DO UPDATE SET until_ts=$3",
        uid, inviter_uid, until)
    await c.answer(t(lang,"invite_muted_ok"), show_alert=True)
    try: await c.message.edit_reply_markup(reply_markup=None)
    except Exception: pass
...
async def cmd_addfriend(msg: Message):
    ...
    if len(parts) < 2:
        await send(msg.chat.id, "📋 /addfriend <id или @username>"); return
    await do_addfriend(uid, msg.chat.id, parts[1].strip())
...
async def cmd_purchases(msg: Message):
    ...
    if len(p) >= 2:
        ...
        title = f"🛍 <b>Покупки {await mention(tu['uid'], tu['name'])}</b> (<code>{tu['uid']}</code>)"
    else:
...
async def cb_shopm(c: CallbackQuery):
    ...
    if act == "stars":
        ...
        friends = await dba(
            "SELECT u.uid, u.name FROM friendships f "
            "JOIN users u ON u.uid = (CASE WHEN f.uid_a=$1 THEN f.uid_b ELSE f.uid_a END) "
            "WHERE (f.uid_a=$1 OR f.uid_b=$1) AND f.status='accepted' ORDER BY u.name LIMIT 20", uid)
        if not friends:
            await sedit(cid, c.message.message_id, t(lang,"gift_no_friends"),
                       kb=IKM(inline_keyboard=[[IKB(text=t(lang,"btn_back"), callback_data="shopm|back")]]))
        else:
            rows = [[IKB(text=f["name"], callback_data=f"giftpick|{f['uid']}")] for f in friends]
            rows.append([IKB(text=t(lang,"btn_back"), callback_data="shopm|back")])
            await sedit(cid, c.message.message_id, t(lang,"gift_pick_friend"), kb=IKM(inline_keyboard=rows))
    else:  # back
        await sedit(cid, c.message.message_id, t(lang,"shop"), kb=shop_main_kb(lang))

@dp.callback_query(F.data.startswith("giftpick|"))
async def cb_giftpick(c: CallbackQuery):
    uid = c.from_user.id; cid = c.message.chat.id
    lang = await eff_lang(cid, uid); target = int(c.data.split("|")[1]); await c.answer()
    rows = [[IKB(text=f"{amt}💎 — {cost}⭐", callback_data=f"giftamt|{target}|{code}")]
            for code,(amt,cost) in GIFT_DIAMOND_PACKS.items()]
    rows.append([IKB(text=t(lang,"btn_back"), callback_data="shopm|gift")])
    await sedit(cid, c.message.message_id, t(lang,"gift_pick_amount"), kb=IKM(inline_keyboard=rows))

@dp.callback_query(F.data.startswith("giftamt|"))
async def cb_giftamt(c: CallbackQuery):
    uid = c.from_user.id; cid = c.message.chat.id
    _, target_s, code = c.data.split("|")
    target = int(target_s)
    lang = await eff_lang(cid, uid)
    if code not in GIFT_DIAMOND_PACKS: await c.answer(); return
    amount, tg_cost = GIFT_DIAMOND_PACKS[code]; await c.answer()
    await bot.send_invoice(
        chat_id=cid, title=t(lang,"gift_invoice_title", amt=amount),
        description=t(lang,"gift_invoice_desc"),
        payload=f"bjgift_{amount}_{target}_{uid}",
        provider_token="", currency="XTR",
        prices=[LabeledPrice(label=f"{amount}💎", amount=tg_cost)],
    )
...
async def payment_ok(msg: Message):
    ...
    if kind_tag == "bjstar" and len(parts) >= 3 and parts[1] in STAR_PACKS:
        ...
        payer = await gu(uid)
        payer_name = (payer or {}).get("name") or "Друг"
        tlang = await get_lang(target_uid)
        await send(target_uid, t(tlang,"gift_received", name=payer_name, amt=amount))
...
# ── MAIN ────────────────────────────────────────────────────────────────────
@dp.inline_query()
async def inline_duel(q: InlineQuery):
    uid = q.from_user.id
    await ensure_ids(uid, q.from_user.first_name or "", q.from_user.username or "")
    lang = await get_lang(uid)
    parts = (q.query or "").strip().split()
    usage = InlineQueryResultArticle(
        id="usage", title=t(lang,"duel_usage_title"),
        description=t(lang,"duel_usage_desc"),
        input_message_content=InputTextMessageContent(message_text=t(lang,"duel_usage_desc")))
    if len(parts) < 2:
        await q.answer([usage], cache_time=1, is_personal=True); return
    ...
    if bet < MIN_BET or bet > MAX_BET:
        err = InlineQueryResultArticle(
            id="err_bet", title=t(lang,"duel_bad_bet_title"),
            description=t(lang,"duel_bad_bet_desc", mn=MIN_BET, mx=MAX_BET),
            input_message_content=InputTextMessageContent(message_text=t(lang,"duel_bad_bet_desc", mn=MIN_BET, mx=MAX_BET)))
        await q.answer([err], cache_time=1, is_personal=True); return
    tu = await gu_un(uname)
    if not tu or tu["uid"] == uid:
        err = InlineQueryResultArticle(
            id="err_user", title=t(lang,"duel_user_notfound_title"),
            description=t(lang,"duel_user_notfound_desc"),
            input_message_content=InputTextMessageContent(message_text=t(lang,"duel_user_notfound_desc")))
        await q.answer([err], cache_time=1, is_personal=True); return
    me = await gu(uid)
    if not me or me["bal"] < bet:
        err = InlineQueryResultArticle(
            id="err_bal", title=t(lang,"duel_no_balance_title"),
            description=t(lang,"duel_no_balance_desc"),
            input_message_content=InputTextMessageContent(message_text=t(lang,"duel_no_balance_desc")))
        await q.answer([err], cache_time=1, is_personal=True); return
    row = await dbq(
        "INSERT INTO duels(creator_uid,opponent_uid,bet,status,created_at) VALUES($1,$2,$3,'pending',$4) RETURNING id",
        uid, tu["uid"], bet, int(time.time()))
    duel_id = row["id"]
    my_name = me["name"] or q.from_user.first_name or "Player"
    op_name = tu["name"] or uname
    text = t(lang,"duel_card", a=html.escape(my_name), b=html.escape(op_name), bet=f"{bet:,}")
    kb = IKM(inline_keyboard=[[IKB(text=t(lang,"duel_accept_btn"), callback_data=f"duel_accept|{duel_id}")]])
    result = InlineQueryResultArticle(
        id=f"duel_{duel_id}", title=t(lang,"duel_result_title", name=op_name),
        description=t(lang,"duel_result_desc", bet=f"{bet:,}"),
...
async def cb_duel_accept(c: CallbackQuery):
    ...
    uid = c.from_user.id
    lang = await get_lang(uid)
    duel = await dbq("SELECT * FROM duels WHERE id=$1", duel_id)
    if not duel or duel["status"] not in ("pending","accepted"):
        await c.answer(t(lang,"duel_gone"), show_alert=True); return
    if uid == duel["creator_uid"]:
        await c.answer(t(lang,"duel_cant_accept_own"), show_alert=True); return
    if uid != duel["opponent_uid"]:
        await c.answer(t(lang,"duel_wrong_player"), show_alert=True); return
    if duel["status"] == "pending":
        me = await gu(uid)
        if not me or me["bal"] < duel["bet"]:
            await c.answer(t(lang,"duel_no_balance_title"), show_alert=True); return
        await dbx("UPDATE duels SET status='accepted' WHERE id=$1", duel_id)
    creator = await gu(duel["creator_uid"])
    opp = await gu(duel["opponent_uid"])
    a_name = html.escape((creator or {}).get("name") or "Player")
    b_name = html.escape((opp or {}).get("name") or "Player")
    text = t(lang,"duel_accepted_card", a=a_name, b=b_name, bet=f"{duel['bet']:,}")
    url = f"{WEBAPP_URL}?duel={duel_id}" if WEBAPP_URL else WEBAPP_URL
    kb = IKM(inline_keyboard=[[IKB(text=t(lang,"duel_open_btn"), web_app=WebAppInfo(url=url))]]) if WEBAPP_URL else None
    try:
        await bot.edit_message_text(text, inline_message_id=c.inline_message_id, reply_markup=kb)
    except Exception:
        pass
    await c.answer(t(lang,"duel_accepted_ok"))

async def main():
    await init_db()
    log.info("Diamondting (aiogram3 + PostgreSQL)…")
    await bot.delete_webhook(drop_pending_updates=True)
    await dp.start_polling(bot, allowed_updates=["message","callback_query","pre_checkout_query","inline_query"])
