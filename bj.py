...
TX['en'] = {
    ...
    'ref_msg': '🔗 <b>Invite friends</b>\n\nInvited so far: <b>{n}</b>\n\nYou get <b>+3💎</b> per invite (👑 VIP: +5💎).\nYour friend gets <b>+5,000¢</b> too.\n\n🎁 <b>3 referrals</b> → exclusive card skin\n🎗️ <b>5 referrals</b> → exclusive profile frame\n(these can\'t be bought — only earned)\n\nTap below to share your link:',
    'friends_msg': '👥 <b>Friends</b>\n\nFriends: <b>{n}</b>\nPending requests: <b>{req}</b>\n\nManage your friends list, send/accept requests, and invite them to play — all in the Mini App:',
    'btn_open_friends': '👥 Open Friends',
    ...
    'ref_milestone_skin': '🎁 Milestone reached — 3 referrals! You unlocked an exclusive card skin, available only through the referral program. Check the Mini App shop.',
    'ref_milestone_frame': '🎗️ Milestone reached — 5 referrals! You unlocked an exclusive profile frame, available only through the referral program. Check the Mini App shop.',
    ...
    'gift_received': '🎁 <b>{name}</b> sent you <b>{amt}💎</b> as a gift!',
    'gift_sent_ok': '✅ Gift sent — your friend received <b>{amt}💎</b>!',
    ...
    'r_lose': '❌ {m}  Loss\n{h}  −<b>{b:,}¢</b>',
    'r_bust': '💥 {m}  Bust\n{h}  −<b>{b:,}¢</b>',
    'r_bust_push': '💥 {m}  Bust — but dealer busted too\n{h}  returned <b>{b:,}¢</b>',
    ...
    'btn_howto_inline': '🎲 How to play Duel (inline)',
    'how_to_inline': (
        "🎲 <b>Blackjack Duel — inline mode</b>\n\n"
        "🚀 <b>How to launch:</b>\n"
        "In ANY chat — a DM, a group, anywhere — type:\n"
        "<code>@{bot} @username 1000</code>\n"
        "where <code>@username</code> is who you're challenging and <code>1000</code> is the bet. "
        "A duel card appears there for both of you to see.\n\n"
        "✅ Only the challenged player can tap <b>Accept</b> — anyone else tapping it just sees an error.\n\n"
        "🃏 <b>How to play:</b>\n"
        "1️⃣ Once accepted, you both open the Mini App from the card\n"
        "2️⃣ You each get 2 cards. You see your own fully — but only ONE of your opponent's, the other stays hidden\n"
        "3️⃣ 🃏 Hit to draw another card, ✋ Stand to stop\n"
        "4️⃣ Once you're both done, hidden cards flip and the higher hand (without busting) wins\n\n"
        "💰 The winner takes both bets."
    ),
    'duel_title': 'Blackjack Duel', 'duel_waiting': 'Waiting for opponent…', 'duel_started': 'Game starting…',
    'duel_card': '🃏 <b>Blackjack Duel</b>\n\n👤 {a} <b>VS</b> 👤 {b}\n💰 Bet: <b>{bet}¢</b>\n\n{status}',
    'duel_desc': 'Bet: {bet}¢ — tap to send the challenge',
    'duel_accept_btn': '✅ Accept duel', 'duel_open_btn': '🎲 Open Mini App',
    'duel_user_not_found': 'User not found', 'duel_user_not_found_desc': '{u} hasn\'t used this bot — they need to message it at least once first.',
    'duel_cant_self': 'You can\'t duel yourself 😅',
    'duel_bad_bet': 'Invalid bet', 'duel_bad_bet_desc': 'Bet must be between {mn} and {mx}.',
    'duel_not_enough': 'Not enough balance for this bet.',
    'duel_creator_broke': 'The challenger no longer has enough balance — duel cancelled.',
    'duel_gone': 'This duel no longer exists.', 'duel_no_longer_pending': 'This duel is no longer available.',
    'duel_not_for_you': '❌ This duel is for another player.',
    'duel_accepted_toast': '✅ Accepted! Opening the table…',
    'duel_expired': '⌛ <b>Blackjack Duel</b>\n\n👤 {a} vs 👤 {b}\n💰 Bet: {bet}¢\n\nExpired — nobody accepted in time.',
    'duel_dm_ready': '⚔️ Your duel is starting! Bet: <b>{bet}¢</b>. Tap below to open the table.',
    'duel_howto_title': '⚔️ Challenge a friend to a duel',
    'duel_howto_desc': 'Type: @username 1000 (their username and your bet) to send a duel challenge.',
    'btn_report': '📝 Support',
    'btn_vip': '👑 VIP',
    'btn_yes': '✅ Confirm',
    'btn_no': '❌ Cancel',
...
TX['ru'] = {
    ...
    'ref_msg': '🔗 <b>Зови друзей</b>\n\nПриглашено уже: <b>{n}</b>\n\nТы получаешь <b>+3💎</b> за каждого друга (👑 VIP: +5💎).\nДруг получает <b>+5 000¢</b>.\n\n🎁 <b>3 реферала</b> → эксклюзивный скин карт\n🎗️ <b>5 рефералов</b> → эксклюзивная рамка профиля\n(их нельзя купить — только заработать)\n\nНажми кнопку ниже, чтобы поделиться ссылкой:',
    'friends_msg': '👥 <b>Друзья</b>\n\nДрузей: <b>{n}</b>\nВходящих заявок: <b>{req}</b>\n\nСписок друзей, заявки и приглашения сыграть — всё в мини-аппе:',
    'btn_open_friends': '👥 Открыть друзей',
    ...
    'ref_milestone_skin': '🎁 Достижение — 3 реферала! Открыт эксклюзивный скин карт, доступный только через реферальную программу. Загляни в магазин мини-аппа.',
    'ref_milestone_frame': '🎗️ Достижение — 5 рефералов! Открыта эксклюзивная рамка профиля, доступная только через реферальную программу. Загляни в магазин мини-аппа.',
    ...
    'gift_received': '🎁 <b>{name}</b> подарил(а) тебе <b>{amt}💎</b>!',
    'gift_sent_ok': '✅ Подарок отправлен — друг получил <b>{amt}💎</b>!',
    ...
    'r_lose': '❌ {m}  Поражение\n{h}  −<b>{b:,}¢</b>',
    'r_bust': '💥 {m}  Перебор\n{h}  −<b>{b:,}¢</b>',
    'r_bust_push': '💥 {m}  Перебор — но у дилера тоже перебор\n{h}  возврат <b>{b:,}¢</b>',
    ...
    'btn_howto_inline': '🎲 Как играть в дуэль (инлайн)',
    'how_to_inline': (
        "🎲 <b>Blackjack Дуэль — инлайн-режим</b>\n\n"
        "🚀 <b>Как запустить:</b>\n"
        "В ЛЮБОМ чате — в личке, в группе, где угодно — напиши:\n"
        "<code>@{bot} @username 1000</code>\n"
        "где <code>@username</code> — кого вызываешь, а <code>1000</code> — ставка. "
        "Появится карточка дуэли, видная вам обоим.\n\n"
        "✅ Принять вызов может только указанный игрок — если нажмёт кто-то другой, он увидит ошибку.\n\n"
        "🃏 <b>Как играть:</b>\n"
        "1️⃣ После принятия оба открывают Mini App прямо с карточки\n"
        "2️⃣ Каждому по 2 карты. Свои видишь полностью — у соперника видна только ОДНА, вторая скрыта\n"
        "3️⃣ 🃏 Взять — ещё карту, ✋ Стоп — остановиться\n"
        "4️⃣ Когда оба закончили — скрытые карты открываются, побеждает старшая рука без перебора\n\n"
        "💰 Победитель забирает обе ставки."
    ),
    'duel_title': 'Blackjack Дуэль', 'duel_waiting': 'Ожидание соперника…', 'duel_started': 'Игра начинается…',
    'duel_card': '🃏 <b>BlackJack Duel</b>\n\n👤 {a} <b>VS</b> 👤 {b}\n💰 Ставка: <b>{bet}¢</b>\n\n{status}',
    'duel_desc': 'Ставка: {bet}¢ — нажми, чтобы отправить вызов',
    'duel_accept_btn': '✅ Принять дуэль', 'duel_open_btn': '🎲 Открыть Mini App',
    'duel_user_not_found': 'Пользователь не найден', 'duel_user_not_found_desc': '{u} ещё не писал(а) этому боту — сначала ему нужно один раз запустить бота.',
    'duel_cant_self': 'Нельзя вызвать самого себя 😅',
    'duel_bad_bet': 'Некорректная ставка', 'duel_bad_bet_desc': 'Ставка должна быть от {mn} до {mx}.',
    'duel_not_enough': 'Недостаточно баланса для этой ставки.',
    'duel_creator_broke': 'У создателя дуэли больше не хватает баланса — дуэль отменена.',
    'duel_gone': 'Эта дуэль больше не существует.', 'duel_no_longer_pending': 'Эта дуэль уже недоступна.',
    'duel_not_for_you': '❌ Эта дуэль предназначена для другого игрока.',
    'duel_accepted_toast': '✅ Принято! Открываю стол…',
    'duel_expired': '⌛ <b>Blackjack Duel</b>\n\n👤 {a} vs 👤 {b}\n💰 Ставка: {bet}¢\n\nВремя вышло — никто не принял вызов.',
    'duel_dm_ready': '⚔️ Твоя дуэль начинается! Ставка: <b>{bet}¢</b>. Нажми ниже, чтобы открыть стол.',
    'duel_howto_title': '⚔️ Вызвать друга на дуэль',
    'duel_howto_desc': 'Напиши: @username 1000 (юзернейм соперника и твоя ставка), чтобы отправить вызов на дуэль.',
...
def _build_kb_cmd():
    ...
    pairs = [("btn_play","play"),("btn_profile","profile"),("btn_bonus","bonus"),
             ...
             ("btn_upgrade","upgrade"),("btn_friends","friends"),
...
CREATE INDEX IF NOT EXISTS idx_friendships_b ON friendships(uid_b);
CREATE TABLE IF NOT EXISTS duels(
    id BIGSERIAL PRIMARY KEY,
    creator_uid BIGINT NOT NULL,
    creator_name TEXT NOT NULL,
    opponent_uid BIGINT NOT NULL,
    opponent_name TEXT NOT NULL,
    bet BIGINT NOT NULL,
    status TEXT NOT NULL DEFAULT 'pending',   -- pending | accepted | declined | expired | done
    inline_msg_id TEXT,
    room_id TEXT,
...
async def init_db():
    ...
    async with pool.acquire() as c:
        ...
        migrations = [
            ...
            "ALTER TABLE users ADD COLUMN IF NOT EXISTS mute_invites_until BIGINT DEFAULT 0",
...
async def ensure_ids(uid: int, fname: str, uname: str = ""):
    async with pool.acquire() as c:
        ...
        await c.execute("UPDATE users SET name=$1,username=$2,last_seen=$3 WHERE uid=$4",
            fname or "", uname, int(time.time()), uid)
...
_sub_check_alerted: set = set()  # channels we already pinged the owner about (avoid spam)
...
async def is_subscribed(uid: int) -> bool:
    ...
    try:
        ...
        # This is the actual reason the sub-check "didn't work": if the bot
        # isn't an admin in CHANNEL_USERNAME (or the username/ID is wrong),
        # get_chat_member fails for EVERY user, and the old code returned
        # True here — silently letting everyone through the gate. Now we
        # deny by default and alert the owner once so it gets fixed at the
        # source (add the bot as admin in the channel).
        log.error(f"is_subscribed: can't check membership in {CHANNEL_USERNAME} "
                  f"({e}) — is the bot an admin there?")
        if CHANNEL_USERNAME not in _sub_check_alerted:
            _sub_check_alerted.add(CHANNEL_USERNAME)
            try:
                await bot.send_message(CREATOR_ID,
                    f"⚠️ Не могу проверить подписку на {CHANNEL_USERNAME}: {e}\n"
                    f"Похоже бот не добавлен админом в канал — поэтому проверка "
                    f"подписки при бонусе/промокоде не срабатывала.")
            except Exception:
                pass
        return False
    except Exception as e:
        log.warning(f"is_subscribed uid={uid} unexpected error: {e} — allowing (transient failure)")
        return True   # transient/network errors: don't block users for our own hiccups
...
# ── DEALER AI (probability-based, style-configurable) ──────────────────────
class Dealer:
    """
    Реалистичный дилер для Blackjack.

    Дилер видит ТОЛЬКО свою руку — карты игроков сюда никогда не передаются
    и не влияют на решение. Колода на каждой раздаче новая, прошлые игры
    не учитываются (никакого состояния между раздачами не хранится).

    Решение принимается вероятностно на основе суммы очков и "мягкости"
    руки (туз как 11). Небольшая случайность не даёт дилеру быть
    полностью детерминированным, но не позволяет ему делать явные ошибки
    (например брать при 18+ или стоять при 11).

    Стили (style):
      conservative — берёт чуть реже (осторожнее)
      normal       — стандартное поведение казино (по умолчанию)
      aggressive   — берёт чуть чаще, более рискованный
    """

    BASE_HIT_PROB = {
        4: 1.0, 5: 1.0, 6: 1.0, 7: 1.0, 8: 1.0, 9: 1.0, 10: 1.0, 11: 1.0,
        12: 0.95, 13: 0.95, 14: 0.95,
        15: 0.90,
        16: 0.80,
        ("soft", 17): 0.70,   # Soft 17
        17: 0.0,               # Hard 17 — всегда стоп
    }
    ...
    RANDOM_JITTER = 0.04  # небольшой случайный шум, не ломающий базовую стратегию

    def __init__(self, style: str = "normal"):
        if style not in self.STYLE_SHIFT:
            style = "normal"
        self.style = style

    def set_style(self, style: str) -> bool:
        """Сменить стиль дилера на лету (например, из админ-команды)."""
        if style in self.STYLE_SHIFT:
            self.style = style
            return True
        return False

    def _hit_probability(self, hand) -> float:
        total = htot(hand)
        soft = is_soft(hand)
        ...
        if total == 17:
            if not soft:
                return 0.0  # hard 17 — жёсткое правило, стиль не трогает
            base = self.BASE_HIT_PROB[("soft", 17)]
        else:
            base = self.BASE_HIT_PROB.get(total, 0.0)

        shift = self.STYLE_SHIFT[self.style]
        jitter = random.uniform(-self.RANDOM_JITTER, self.RANDOM_JITTER)
        return max(0.0, min(1.0, base + shift + jitter))

    def decide(self, hand) -> str:
        """Вернуть "hit" или "stand" для текущей руки дилера."""
        if htot(hand) > 21:
            return "stand"
        return "hit" if random.random() < self._hit_probability(hand) else "stand"


# Единственный экземпляр дилера бота. Стиль меняется на лету, например
# командой /dealer_style conservative|normal|aggressive (см. ниже).
DEALER = Dealer(style="normal")
...
async def reply_kb(uid):
    ...
    kb = [
        ...
        [KB(text=t(lang,"btn_ref")),     KB(text=t(lang,"btn_friends"))],
...
def settings_kb(lang):
    ...
    return IKM(inline_keyboard=[
        ...
        [IKB(text=t(lang,"btn_howto_inline"), callback_data="set|howto_inline")],
...
async def bj_dealer(acid, n):
    ...
    dl = tb["dealer"]
    while DEALER.decide(dl) == "hit" and tb["deck"]:
    ...
    for p in tb["players"]:
        ...
        if is_bj(p["hand"]) and not is_bj(tb["dealer"]):
            ...
            if dt > 21:
                ...
                lines.append(t(lang,"r_bust_push", m=mn, h=hand, b=bet))
            else:
...
async def do_ref(uid, cid):
    ...
    n_invited = (await dbq("SELECT COUNT(*) AS n FROM users WHERE ref_by=$1", uid))["n"]
    await send(cid, t(lang,"ref_msg", n=n_invited), kb=share_kb(lang, link))

async def do_friends(uid, cid):
    lang = await eff_lang(cid, uid)
    n_friends = (await dbq(
        "SELECT COUNT(*) AS n FROM friendships WHERE (uid_a=$1 OR uid_b=$1) AND status='accepted'", uid))["n"]
    n_incoming = (await dbq(
        "SELECT COUNT(*) AS n FROM friendships WHERE (uid_a=$1 OR uid_b=$1) AND status='pending' AND requested_by!=$1",
        uid))["n"]
    text = t(lang, "friends_msg", n=n_friends, req=n_incoming)
    kb = None
    if WEBAPP_URL:
        kb = IKM(inline_keyboard=[[IKB(text=t(lang,"btn_open_friends"), web_app=WebAppInfo(url=WEBAPP_URL))]])
    await send(cid, text, kb=kb)
...
async def _dispatch(cmd, uid, fname, cid, raw_text, reply_msg, is_admin):
    ...
    elif cmd == "friends":  await do_friends(uid, cid)
...
async def _apply_pending_ref(uid, fname, lang):
    ...
    if ref and ref["uid"] != uid and not u0["ref_by"]:
        ...
        ref_count = (await dbq("SELECT COUNT(*) AS n FROM users WHERE ref_by=$1", ref["uid"]))["n"]
        if ref_count == 3:
            await dbx("INSERT INTO cosmetics_owned(uid,item_code,acquired) VALUES($1,'referral3',$2) "
                      "ON CONFLICT DO NOTHING", ref["uid"], int(time.time()))
            await send(ref["uid"], t(rlang,"ref_milestone_skin"))
        elif ref_count == 5:
            await dbx("INSERT INTO cosmetics_owned(uid,item_code,acquired) VALUES($1,'referral5',$2) "
                      "ON CONFLICT DO NOTHING", ref["uid"], int(time.time()))
            await send(ref["uid"], t(rlang,"ref_milestone_frame"))
...
@dp.message(Command("dealer_style"))
async def cmd_dealer_style(msg: Message):
    if not _cr(msg): return
    p = (msg.text or "").split()
    if len(p) < 2 or p[1].lower() not in Dealer.STYLE_SHIFT:
        await send(msg.chat.id,
            f"📋 /dealer_style conservative|normal|aggressive\nТекущий: <b>{DEALER.style}</b>")
        return
    DEALER.set_style(p[1].lower())
    await send(msg.chat.id, f"✅ Стиль дилера: <b>{DEALER.style}</b>")
...
async def cmd_groups(msg: Message):
    if not _cr(msg): return
    rows = await dba(
        "SELECT cid, COUNT(*) AS players FROM group_players GROUP BY cid ORDER BY players DESC LIMIT 100")
    if not rows:
        await send(msg.chat.id, "📋 Бот пока не использовался ни в одной группе."); return
    lines = [f"📋 <b>Группы бота</b> ({len(rows)}):\n"]
    for r in rows:
        cid = r["cid"]
        title, members = f"chat {cid}", "?"
        try:
        ...
        try:
            ...
            pass
        lines.append(f"• <b>{title}</b>\n  ID: <code>{cid}</code> · участников: {members} · играли в BJ: {r['players']}")
    text = "\n".join(lines)
    for i in range(0, len(text), 3500):
        await send(msg.chat.id, text[i:i+3500])
...
async def cb_settings(c: CallbackQuery):
    ...
    elif act == "howto_inline":
        try: bname = (await bot.get_me()).username
        except Exception: bname = "BJonlinebot"
        await sedit(cid, c.message.message_id, t(lang,"how_to_inline", bot=bname), kb=back_kb(lang))
    elif act == "report":
        if is_pm(cid):
...
DUEL_EXPIRE_SECONDS = 300  # a pending duel auto-expires if nobody accepts within 5 min

@dp.inline_query()
async def inline_query_duel(iq: InlineQuery):
    """Type "@BotUsername @friend_username 1000" in any chat to challenge
    @friend_username to a 1v1 duel for 1000 chips. Only that player can accept —
    see cb_duel_accept below."""
    await ensure_ids(iq.from_user.id, iq.from_user.first_name or "", iq.from_user.username or "")
    lang = await get_lang(iq.from_user.id)
    parts = (iq.query or "").strip().split()
    results = []

    def article(rid, title, body):
        return InlineQueryResultArticle(id=rid, title=title, description=body,
            input_message_content=InputTextMessageContent(message_text=body, parse_mode="HTML"))

    if len(parts) >= 2 and parts[0].startswith("@"):
        target_uname = parts[0]
        try: bet = int(parts[1])
        except ValueError: bet = None

        target = await gu_un(target_uname)
        me = await gu(iq.from_user.id)

        if not target:
            results.append(article("err_nouser", "❌ " + t(lang,"duel_user_not_found"),
                t(lang,"duel_user_not_found_desc", u=target_uname)))
        elif target["uid"] == iq.from_user.id:
            results.append(article("err_self", "❌ " + t(lang,"duel_cant_self"), t(lang,"duel_cant_self")))
        elif bet is None or bet < MIN_BET or bet > MAX_BET:
            results.append(article("err_bet", "❌ " + t(lang,"duel_bad_bet"),
                t(lang,"duel_bad_bet_desc", mn=MIN_BET, mx=MAX_BET)))
        elif not me or me["bal"] < bet:
            results.append(article("err_bal", "❌ " + t(lang,"duel_not_enough"), t(lang,"duel_not_enough")))
        else:
            me_name = me["name"] or iq.from_user.first_name or "Player"
            opp_name = target["name"] or target_uname.lstrip("@")
            row = await dbq(
                "INSERT INTO duels(creator_uid,creator_name,opponent_uid,opponent_name,bet,status,created_at) "
                "VALUES($1,$2,$3,$4,$5,'pending',$6) RETURNING id",
                iq.from_user.id, me_name, target["uid"], opp_name, bet, int(time.time()))
            duel_id = row["id"]
            text = t(lang,"duel_card", a=me_name, b=opp_name, bet=bet, status=t(lang,"duel_waiting"))
            kb = IKM(inline_keyboard=[[IKB(text=t(lang,"duel_accept_btn"), callback_data=f"dacc|{duel_id}")]])
            results.append(InlineQueryResultArticle(
                id=f"duel_{duel_id}", title=f"⚔️ {t(lang,'duel_title')} vs {target_uname}",
                description=t(lang,"duel_desc", bet=bet),
                input_message_content=InputTextMessageContent(message_text=text, parse_mode="HTML"),
                reply_markup=kb))
    else:
        results.append(article("help", t(lang,"duel_howto_title"), t(lang,"duel_howto_desc")))

    try:
        await iq.answer(results, cache_time=1, is_personal=True)
    except Exception as e:
        log.warning(f"inline_query answer failed: {e}")


@dp.chosen_inline_result()
async def chosen_inline_result_duel(cr: ChosenInlineResult):
    if cr.result_id.startswith("duel_"):
        duel_id = int(cr.result_id.split("_", 1)[1])
        await dbx("UPDATE duels SET inline_msg_id=$1 WHERE id=$2", cr.inline_message_id, duel_id)
        asyncio.create_task(_expire_duel_later(duel_id))


async def _expire_duel_later(duel_id: int):
    await asyncio.sleep(DUEL_EXPIRE_SECONDS)
    d = await dbq("SELECT * FROM duels WHERE id=$1", duel_id)
    if not d or d["status"] != "pending":
        return
    await dbx("UPDATE duels SET status='expired' WHERE id=$1", duel_id)
    if d["inline_msg_id"]:
        lang = await get_lang(d["creator_uid"])
        try:
            await bot.edit_message_text(
                t(lang,"duel_expired", a=d["creator_name"], b=d["opponent_name"], bet=d["bet"]),
                inline_message_id=d["inline_msg_id"])
        except Exception:
            pass


@dp.callback_query(F.data.startswith("dacc|"))
async def cb_duel_accept(c: CallbackQuery):
    duel_id = int(c.data.split("|")[1])
    d = await dbq("SELECT * FROM duels WHERE id=$1", duel_id)
    lang = await get_lang(c.from_user.id)

    if not d:
        await c.answer(t(lang,"duel_gone"), show_alert=True); return
    if d["status"] != "pending":
        await c.answer(t(lang,"duel_no_longer_pending"), show_alert=True); return
    if c.from_user.id != d["opponent_uid"]:
        # Per spec: the accept button is visible to everyone, but only the
        # challenged player may actually use it.
        await c.answer(t(lang,"duel_not_for_you"), show_alert=True); return

    bet = d["bet"]
    creator = await gu(d["creator_uid"])
    opp = await gu(d["opponent_uid"])
    if not creator or creator["bal"] < bet:
        await c.answer(t(lang,"duel_creator_broke"), show_alert=True)
        await dbx("UPDATE duels SET status='cancelled' WHERE id=$1", duel_id)
        return
    if not opp or opp["bal"] < bet:
        await c.answer(t(lang,"duel_not_enough"), show_alert=True); return

    await add_bal(d["creator_uid"], -bet)   # both stakes are held for the duration of the duel
    await add_bal(d["opponent_uid"], -bet)
    await dbx("UPDATE duels SET status='accepted' WHERE id=$1", duel_id)
    await c.answer(t(lang,"duel_accepted_toast"))

    text = t(lang,"duel_card", a=d["creator_name"], b=d["opponent_name"], bet=bet, status=t(lang,"duel_started"))
    kb = None
    dm_kb = None
    if WEBAPP_URL:
        url = f"{WEBAPP_URL}{'&' if '?' in WEBAPP_URL else '?'}duel={duel_id}"
        kb = IKM(inline_keyboard=[[IKB(text=t(lang,"duel_open_btn"), web_app=WebAppInfo(url=url))]])
        dm_kb = kb
    try:
        await bot.edit_message_text(text, inline_message_id=c.inline_message_id, reply_markup=kb)
    except Exception as e:
        log.warning(f"duel accept edit failed: {e}")

    if dm_kb:  # also DM both players directly — the inline card can be awkward to tap back into
        for uid in (d["creator_uid"], d["opponent_uid"]):
            try:
                ulang = await get_lang(uid)
                await bot.send_message(uid, t(ulang,"duel_dm_ready", bet=bet), reply_markup=dm_kb)
            except Exception:
                pass


@dp.callback_query(F.data == "muteinv_1d")
async def cb_mute_invites(c: CallbackQuery):
    uid = c.from_user.id
    until = int(time.time()) + 86400
    await dbx("UPDATE users SET mute_invites_until=$1 WHERE uid=$2", until, uid)
    lang = await get_lang(uid)
    await c.answer("🔕 Приглашения выключены на 24 часа" if lang == "ru" else "🔕 Invites muted for 24h", show_alert=True)
    try:
...
async def payment_ok(msg: Message):
    ...
    # or:             "bjgift_{amount}_{target_uid}_{payer_uid}" — gift, credits target_uid
    parts = payload.split("_")
    kind_tag = parts[0] if parts else ""
    lang = await get_lang(uid)
    if kind_tag == "bjstar" and len(parts) >= 3 and parts[1] in STAR_PACKS:
        code = parts[1]
        label, tg_cost, bs_amt = STAR_PACKS[code]
    ...
    elif kind_tag == "bjgift" and len(parts) >= 4:
        try:
            amount = int(parts[1]); target_uid = int(parts[2])
        except ValueError:
            await send(uid, "✅ Payment received!"); return
        await add_stars(target_uid, amount)
        await record_purchase(uid, f"gift_{amount}_{target_uid}", msg.successful_payment.total_amount)
        payer = await gu(uid)
        payer_mn = await mention(uid, (payer or {}).get("name") or "Друг")
        tlang = await get_lang(target_uid)
        await send(target_uid, t(tlang,"gift_received", name=payer_mn, amt=amount))
        await send(uid, t(lang,"gift_sent_ok", amt=amount))
    else:
